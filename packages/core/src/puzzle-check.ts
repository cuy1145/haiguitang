...
const CONTENT_RULES: Array<{ label: string; reason: string; words: string[] }> = [
  ...
  {
    // 繁体题库（例：ModelScope 的 Turtle-Bench）必须也能拦住，否则关键词形同虚设
    label: '繁体变体',
    reason: '繁体文本中的高风险内容（与上面同义）',
    words: ['強姦', '性侵', '猥褻', '戀童', '輪姦', '囚禁', '綁架', '拐賣', '虐待', '家暴', '虐殺', '剝皮', '割喉', '碎屍', '肢解', '分屍',
      '眼球', '挖出', '掏空', '內臟', '腸子', '腦漿', '血漿', '啃食', '屍體被',
      '惡魔', '鬼魂', '惡靈', '詛咒', '附體', '殭屍', '吸血鬼', '巫術', '超能力', '外星人', '穿越到', '轉世', '投胎', '通靈', '驅魔'],
  },
];
